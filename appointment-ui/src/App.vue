      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="audio_section p-3">
            <img src="src/assets/redcrossvector.svg" alt="LAPD" class="LAPD_logo">
            <div class="LAPD_name">
              <h3><br>Mumbai <br> Hospital</h3>
            </div>
                    ...
                    <div class="col-lg-12">
                      <div class="lapd_chat d-flex align-items-start justify-content-end mb-4">
                        <div class="chat_text_div d-flex flex-column align-items-end">
                          <p>Namaste, thank you for calling Mumbai Hospital. How can I help you today?</p>
                        </div>
                        <div class="img-box">
...
export default {
  ...
  created: function () {
    ...
    this.stopAudio()
    this.playAudio("Namaste Thank you for calling Mumbai Hospital. How can I help you today?","en","Hello, Thank you for calling the Texas Medical Center. How can I help you today?");
  },
  ...
  methods: {
    ...
    async uploadRecording() {
      ...
      try {
        ...
        if (this.convertedtext.includes('successfully booked')) {
          this.isRecording = false;
        }
        console.log(this.chatJson);
    ...
    async playAudio(text, detectedlanguage, AiEnglishResponse) {
      try {
        ...
        if (AiEnglishResponse.includes('successfully booked')) {
        ...
        console.log(voices)
        //Find a female voice
        const ziraVoice = voices.find(voice => voice.name === 'Microsoft Heera - English (India)');
